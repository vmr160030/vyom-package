...
classdef PresentJitterImagesTest < manookinlab.protocols.ManookinLabStageProtocol
    properties
        amp % Output amplifier
        preTime     = 250 % in ms
        stimTime    = 250 % in ms
        tailTime    = 250 % in ms
        fileFolder = 'vr_test'; % Folder containing images
        ...
        muPerPix = 3.34 % microns per pixel to use for debugging purposes.
    end
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            obj.jitterSpacingPix = obj.jitterSpacing / obj.muPerPix;%obj.rig.getDevice('Stage').um2pix(obj.jitterSpacing);
